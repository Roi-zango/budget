...
/*     */ 
/*     */ 
/*     */ @WebFilter(filterName = "FilterConnexion", urlPatterns = {"/faces/login.xhtml"})
...
/*  81 */       request.getRequestDispatcher("/faces/index.xhtml?faces-redirect=true").forward(request, response);
/*     */     } else {
...
/* Location:              C:\Users\Roi-zango\OneDrive\Bureau\web\WEB-INF\classes\!\filter\FilterConnexion.class
